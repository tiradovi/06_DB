...
-- 3. 데이터 삽입 (3권의 책)
-- 힌트: B001, B002, B003
INSERT INTO BOOK VALUES ('B001', 'TITLE1', 'AUTHOR1', 3000, 5);
INSERT INTO BOOK VALUES ('B002', 'TITLE2', 'AUTHOR2', 4000, 6);
INSERT INTO BOOK VALUES ('B003', 'TITLE3', 'AUTHOR3', 5000, DEFAULT);

-- 4. 컬럼 추가
-- 힌트: ALTER TABLE ADD, CATEGORY 컬럼 추가
ALTER TABLE BOOK ADD COLUMN CATEGORY VARCHAR(30) DEFAULT '기본';
