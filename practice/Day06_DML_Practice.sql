...
VALUES
(NULL,'조민수','minsoo.jo@gmail.com', 'min123!','010-2468-1357','대전시 유성구 대학로 99',now());
...
INSERT INTO STORES
VALUES
(8, '맘스터치 대학로점',9,'대전시 유성구 대학로 100','042-123-4567','수제버거 전문점',12000,2500,4.6, '매일 10:30 - 22:00', now());
...
VALUES
('조민수','minsoo.jo@gmail.com', 'min123!','대전시 유성구 대학로 99'),
...
VALUES
('경기도 고양시 일산서구 주엽동 123','홍지민', '010-9876-1234','jimin.hong@kakao.com','hong987');
...
-- 치킨집을 매일 12시간으로 변경
-- 매일 12 시간과 Chicken은 html에서 소비자가 변경하고자하여 선택하거나 작성한 데이터를 javascript 변수이름을 통해
-- java 서버로 전달되고, java 에서는 javascript로 전달받은 데이터를 java 내부에 설정한 변수이름으로 전달 받은뒤
-- sql로 전달 받은 데이터를 수정 변경하겠다 요청
UPDATE stores
